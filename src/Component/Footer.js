            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Hela Clothing</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracking-wide font-bold uppercase dark:text-coolGray-50">Product</h3>
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide font-bold uppercase dark:text-coolGray-50">Company</h3>
                        <ul className="space-y-1">
                            <li>
                                <a href="#">Privacy</a>
                            </li>
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase font-bold dark:text-coolGray-50 font-bold">Guides</h3>
                        <ul className="space-y-1">
                            <li>
                                <a href="#">Size Chart</a>
                            </li>
                    ...
                    <div className="space-y-3">
                        <div className="uppercase font-bold dark:text-coolGray-50">Social media</div>
